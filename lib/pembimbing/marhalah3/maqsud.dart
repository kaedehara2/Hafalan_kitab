...
class _MaqsudPageState extends State<MaqsudPage> {
  ...
  Future<void> cekDanKirimKhataman(int santriId) async {
    try {
      ...
      debugPrint("PROGRESS MAQSUD : $progress");
      ...
      if (progress >= 100) {
        ...
        if (cekData.isEmpty) {
          ...
          debugPrint("BERHASIL MASUK KHATAMAN MAQSUD");
          if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Kitab Nadzam Maqsud - Catat Hafalan"),
  ...
  // ================= LIST SANTRI (REVISED TO ONE COLUMN LIST) =================
