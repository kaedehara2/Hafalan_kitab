...
class MaqsudPage extends StatefulWidget {
  ...
  @override
  State<MaqsudPage> createState() =>
      _MaqsudPageState();
}

class _MaqsudPageState
    extends State<MaqsudPage> {
    ...
    try {
      ...
      if (progress >= 100) {
        ...
        if (cekData.isEmpty) {
          ...
          debugPrint(
              "BERHASIL MASUK KHATAMAN MAQSUD");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          "Kitab Nadzam Maqsud - Catat Hafalan",
        ),
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText:
                  "Contoh:\nBab Tsulatsi Mujarrad sampai Bab Ruba'i",
