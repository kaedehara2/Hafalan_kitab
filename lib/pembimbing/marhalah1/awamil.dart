...
class AwamilPage extends StatefulWidget {
  ...
  @override
  State<AwamilPage> createState() =>
      _AwamilPageState();
}

class _AwamilPageState
    extends State<AwamilPage> {
  ...
  Future<double> getProgress(int santriId) async {
    ...
    try {
      ...
      // ================= TOTAL TARGET AWAMIL =================
      const int totalTarget = 16;

      int totalSetoran = data.length;

      double progress =
          (totalSetoran / totalTarget) * 100;
  ...
  Future<void> insertHafalan(
    ...
    if (hafalanController.text.isEmpty ||
        penilaian == null) {
      return;
    }
