...
class _DashboardWaliPageState extends State<DashboardWaliPage> {
  ...
  Future<void> loadProgressKitab(int santriId) async {
    ...
    try {
      ...
      // ================= MASUK LIST & FILTER MARHALAH =================
      final marhalahSantri = santri?['marhalah']?.toString() ?? '';

      totalProgress.forEach((kitab, progress) {
        // 🛠️ REVISI FILTER: Batasi tampilan berdasarkan Marhalah aktif santri
        if (marhalahSantri.contains('3')) {
          // Jika santri berada di Marhalah 3, hanya tampilkan imrithi dan maqsud
          if (kitab != 'imrithi' && kitab != 'maqsud') {
            return; // Skip data selain dua kitab ini
          }
        } else if (marhalahSantri.contains('1')) {
          // Contoh filter Marhalah 1 (Sesuaikan dengan kurikulum pondokmu)
          if (kitab != 'awamil') return;
        } else if (marhalahSantri.contains('2')) {
          // Contoh filter Marhalah 2 (Sesuaikan dengan kurikulum pondokmu)
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      ...progressKitab.map((item) {
                        ...
                        // 🛠️ REVISI KOSMETIK: Mengubah huruf pertama menjadi Kapital (contoh: maqsud -> Maqsud)
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: const Column(
                                  children: [
                                    Icon(Icons.analytics, size: 42),
                                    SizedBox(height: 12),
                                    Text('Monitoring Hafalan', textAlign: TextAlign.center),
                                  ],
                                ),
                              ),
                            ),
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: const Column(
                                  children: [
                                    Icon(Icons.fact_check, size: 42),
                                    SizedBox(height: 12),
                                    Text('Riwayat Khataman', textAlign: TextAlign.center),
                                  ],
                                ),
                              ),
                            ),
                      ...
                      InkWell(
                        ...
                        child: const Column(
                          children: [
                            Icon(Icons.chat, size: 42),
                            SizedBox(height: 12),
                            Text('Chat Pembimbing', textAlign: TextAlign.center),
                          ],
                        ),
                      ),
                    ),
